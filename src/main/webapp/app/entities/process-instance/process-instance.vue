  ...
  <div>
      ...
      <table class="table table-striped" aria-describedby="processInstances">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="$t('myAppAgilekipCommunityApp.processInstance.businessKey')">Business Key</span></th>
            ...
            <th scope="row">
              <span v-text="$t('myAppAgilekipCommunityApp.processInstance.camundaProcessInstanceId')">Camunda Process Instance Id</span>
            </th>
            <th scope="row">
              <span v-text="$t('myAppAgilekipCommunityApp.processInstance.camundaProcessVariables')">Camunda Process Variables</span>
            </th>
            <th scope="row"><span v-text="$t('myAppAgilekipCommunityApp.processInstance.processDefinition')">Process Definition</span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span
          id="myAppAgilekipCommunityApp.processInstance.delete.question"
      ...
      <div class="modal-body">
        <p
          id="jhi-delete-processInstance-heading"
          v-text="$t('myAppAgilekipCommunityApp.processInstance.delete.question', { id: removeId })"
        >
