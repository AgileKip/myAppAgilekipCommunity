    ...
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          ...
          v-text="$t('myAppAgilekipCommunityApp.processDefinition.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group" v-if="processDefinition.id">
            <label class="form-control-label" v-text="$t('myAppAgilekipCommunityApp.processDefinition.name')" for="process-definition-name"
              >Name</label
            >
