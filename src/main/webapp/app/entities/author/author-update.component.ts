    ...
    if (this.author.id) {
      this.authorService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('myAppAgilekipCommunityApp.author.updated', { param: param.id });
      ...
      this.authorService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('myAppAgilekipCommunityApp.author.created', { param: param.id });
