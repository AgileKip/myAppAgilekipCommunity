  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="myAppAgilekipCommunityApp.author.home.createOrEditLabel"
          data-cy="AuthorCreateUpdateHeading"
          v-text="$t('myAppAgilekipCommunityApp.author.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('myAppAgilekipCommunityApp.author.name')" for="author-name">Name</label>
            <input
              type="text"
              class="form-control"
              name="name"
