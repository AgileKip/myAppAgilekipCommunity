    ...
    <div class="col-10">
      ...
      <div v-if="taskContext.taskInstance">
        <akip-show-task-instance :taskInstance="taskContext.taskInstance">
          <template v-slot:body>
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('myAppAgilekipCommunityApp.taskSelectPickUpStore.number')">number</label>
              <input
                readonly
                type="text"
                class="form-control"
            ...
            <div class="form-group">
              ...
              >
              <input
                v-if="taskContext.orderBookProcess.order.store"
                readonly
                type="text"
                class="form-control"
                name="store"
                id="order-store"
                data-cy="store"
                :value="taskContext.orderBookProcess.order.store.name"
              />
              <input v-else readonly type="text" class="form-control" name="store" id="order-store" data-cy="store" value="" />
            </div>
          </template>
        ...
        <router-link
          ...
          :to="`/process-definition/OrderBookProcess/task/TaskSelectPickUpStore/${taskContext.taskInstance.id}/execute`"
          tag="button"
