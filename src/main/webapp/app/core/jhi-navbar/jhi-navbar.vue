<template>
  <b-navbar data-cy="navbar" toggleable="md" type="light" class="bg-light">
    <b-navbar-brand class="logo" b-link to="/">
      ...
      <span v-text="$t('global.title')" class="navbar-title">myAppAgilekipCommunity</span> <span class="navbar-version">{{ version }}</span>
    </b-navbar-brand>
    <b-navbar-toggle
      right
    ...
    <b-collapse is-nav id="header-tabs">
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item-dropdown right id="entity-menu" v-if="authenticated" active-class="active" class="pointer" data-cy="entity">
          ...
          <b-dropdown-item to="/order-book">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.orderBook')">Order Book</span>
          </b-dropdown-item>
          <b-dropdown-item to="/publisher">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.publisher')">Publisher</span>
          </b-dropdown-item>
          <b-dropdown-item to="/store">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.store')">Store</span>
          </b-dropdown-item>
