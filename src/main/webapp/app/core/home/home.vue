  ...
  <div class="home row">
    <div class="col-md-9">
      ...
      <ul>
        ...
        <li>
          <a href="https://twitter.com/agilekip" target="_blank" rel="noopener noreferrer" v-text="$t('home.link.follow')"
      ...
      <p>
        ...
        <a href="https://github.com/agilekip/generator-jhipster-agilekip" target="_blank" rel="noopener noreferrer" v-text="$t('home.github')"
          >GitHub</a
        >!
      </p>
    </div>
