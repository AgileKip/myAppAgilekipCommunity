<template>
  ...
  <div class="home row">
    <div class="col-md-9">
      ...
      <p v-text="$t('myAppAgilekipCommunityApp.home.question')">If you have any question on JHipster:</p>
      ...
      <ul>
        <li>
          <a
            ...
            v-text="$t('myAppAgilekipCommunityApp.home.link.homepage')"
            >JHipster homepage</a
          >
        </li>
        <li>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            v-text="$t('myAppAgilekipCommunityApp.home.link.stackoverflow')"
        ...
        <li>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            v-text="$t('myAppAgilekipCommunityApp.home.link.bugtracker')"
        ...
        <li>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            v-text="$t('myAppAgilekipCommunityApp.home.link.follow')"
      ...
      <p>
        <span v-text="$t('myAppAgilekipCommunityApp.home.like')">If you like AgileKip Generator, don't forget to give us a star on</span>
        <a
          href="https://github.com/agilekip/generator-jhipster-agilekip"
          target="_blank"
          rel="noopener noreferrer"
          v-text="$t('myAppAgilekipCommunityApp.home.github')"
          >GitHub</a
        >!
      </p>
    </div>
