...
describe('Service Tests', () => {
  describe('Publisher Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Publisher', async () => {
      ...
      it('should not update a Publisher', async () => {
      ...
      it('should partial update a Publisher', async () => {
      ...
      it('should not partial update a Publisher', async () => {
      ...
      it('should not return a list of Publisher', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Publisher', async () => {
