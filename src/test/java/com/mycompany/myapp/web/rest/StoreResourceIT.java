...
class StoreResourceIT {
    ...
    public static Store createEntity(EntityManager em) {
        Store store = new Store().name(DEFAULT_NAME).city(DEFAULT_CITY).address(DEFAULT_ADDRESS);
        return store;
    }
    ...
    public static Store createUpdatedEntity(EntityManager em) {
        Store store = new Store().name(UPDATED_NAME).city(UPDATED_CITY).address(UPDATED_ADDRESS);
        return store;
    }
    ...
    void putNewStore() throws Exception {
        ...
        updatedStore.name(UPDATED_NAME).city(UPDATED_CITY).address(UPDATED_ADDRESS);
    ...
    void fullUpdateStoreWithPatch() throws Exception {
        ...
        partialUpdatedStore.name(UPDATED_NAME).city(UPDATED_CITY).address(UPDATED_ADDRESS);
