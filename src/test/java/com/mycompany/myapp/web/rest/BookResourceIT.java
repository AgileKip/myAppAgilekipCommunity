...
class BookResourceIT {
    ...
    private static final String DEFAULT_PUB_YEAR = "AAAAAAAAAA";
    private static final String UPDATED_PUB_YEAR = "BBBBBBBBBB";
    ...
    public static Book createEntity(EntityManager em) {
        Book book = new Book().title(DEFAULT_TITLE).pubYear(DEFAULT_PUB_YEAR).price(DEFAULT_PRICE);
        return book;
    }
    ...
    public static Book createUpdatedEntity(EntityManager em) {
        Book book = new Book().title(UPDATED_TITLE).pubYear(UPDATED_PUB_YEAR).price(UPDATED_PRICE);
        return book;
    }
    ...
    void createBook() throws Exception {
        ...
        assertThat(testBook.getPubYear()).isEqualTo(DEFAULT_PUB_YEAR);
    ...
    void getAllBooks() throws Exception {
        ...
        restBookMockMvc
            ...
            .andExpect(jsonPath("$.[*].pubYear").value(hasItem(DEFAULT_PUB_YEAR)))
    ...
    void getBook() throws Exception {
        ...
        restBookMockMvc
            ...
            .andExpect(jsonPath("$.pubYear").value(DEFAULT_PUB_YEAR))
    ...
    void putNewBook() throws Exception {
        ...
        updatedBook.title(UPDATED_TITLE).pubYear(UPDATED_PUB_YEAR).price(UPDATED_PRICE);
        ...
        assertThat(testBook.getPubYear()).isEqualTo(UPDATED_PUB_YEAR);
    ...
    void fullUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.title(UPDATED_TITLE).pubYear(UPDATED_PUB_YEAR).price(UPDATED_PRICE);
